...
namespace Gamekit2D
{
    ...
    public class CharacterController2D : MonoBehaviour
    {
        ...
        public bool isUseScaleFlip = false;
        public bool isOriginFaceRight = true;
        ...
        public void CheckCapsuleEndCollisions(bool bottom = true)
        {
            ...
            {
                m_offset.y = m_Capsule.offset.y;
                m_offset.x = transform.localScale.x > 0 && isOriginFaceRight ? m_Capsule.offset.x : -m_Capsule.offset.x;
                raycastStart = m_Rigidbody2D.position + m_offset;
            ...
            for (int i = 0; i < m_RaycastPositions.Length; i++)
            {
                ...
                Debug.DrawLine(m_RaycastPositions[i], m_RaycastPositions[i] + raycastDirection, Color.red);
